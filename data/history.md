...
**2017**
- **June**: To "surely a SAT solver can help", Linus Torvalds [answers](https://yhbt.net/lore/ksummit-discuss/CA+55aFyvssxg63UoQ-rOaf1TMacJ6T5jyLkWECosQJ_N=9gaaQ@mail.gmail.com/#t): "No. The SAT solver will only hurt, because it will bring in all those irrelevant people who are interested in SAT solving, not in making things easy for users."
...
**2025**
- **February**: The [developers](https://github.com/isselab/configfix?tab=readme-ov-file#credits) of ConfigFix, a [feature-model formula extractor](#extractors) for KConfig, attempt to [merge it](https://lkml.org/lkml/2025/2/8/405) into the kernel.
