...
**2021**
- **May**: Under the supervision of Thorsten Berger and Sarah Nadi, Daniel Jonsson and Patrick Franz [propose](https://ieeexplore.ieee.org/document/9401969) ConfigFix, a [feature-model formula extractor](#extractors) for KConfig that was inspired by [Vegard Nossum's work](https://groups.google.com/g/kconfig-sat/c/G6HA_3ecAQI/m/zrRbr1JjBgAJ) and the [subsequent discussion](https://groups.google.com/g/kconfig-sat/c/G6HA_3ecAQI/m/vn3j0xWCAAAJ) in the context of the [kconfig-sat](https://kernelnewbies.org/KernelProjects/kconfig-sat) initiative.
