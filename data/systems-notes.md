...
- We deliberately exclude some systems (in addition to all systems that use an [ad-hoc technique](#techniques)):
  - [Freetz](https://github.com/Freetz/freetz): Excluded as Freetz-NG already includes the full history of Freetz.
  - [Entware-ng](https://github.com/Entware-ng/Entware-ng): Excluded as Entware already includes the full history of Entware-ng.
  - [uClinux](https://github.com/robutest/uclinux):
  ...
  - [OP-TEE](https://github.com/OP-TEE/optee_os): We omit this system because its current configuration is make-variable based ("Configuration values may be assigned from multiple sources" such as make arguments, `CFG_OPTEE_CONFIG`, environment variables, and platform `conf.mk` files) ([source](https://github.com/OP-TEE/optee_os/blob/master/mk/config.mk)); the 2026 [Initial Kconfig Support](https://github.com/OP-TEE/optee_os/pull/7714) pull request has not been merged yet.
  - [Trusted Firmware-A](https://github.com/TrustedFirmware-A/trusted-firmware-a): We omit this system because it currently uses CMake, with an intention that "later a configuration management tool (e.g. Kconfig) shall be used" ([source](https://github.com/ARM-software/arm-trusted-firmware/blob/master/docs/design_documents/cmake_framework.rst#L67)).
